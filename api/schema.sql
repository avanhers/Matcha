...
--
-- Hôte : mysql:3306
-- Généré le : lun. 05 oct. 2020 à 15:49
...
CREATE TABLE `hash` (
  ...
  `hashForget` int(128) DEFAULT NULL
...
INSERT INTO `likes` (`id`, `likeId`, `likedId`) VALUES
(3, 2, 1),
(4, 3, 1),
(9, 1, 3),
(10, 1, 2);
...
CREATE TABLE `users` (
  ...
  `popularityScore` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `users` (`id`, `email`, `username`, `firstname`, `name`, `password`, `age`, `sexualOrientation`, `description`, `matches`, `gender`, `popularityScore`, `latitude`, `longitude`, `avatar`, `isLogin`) VALUES
...
INSERT INTO `user_tag` (`id`, `userId`, `tagId`) VALUES
(53, 1, 1),
(54, 1, 4),
(55, 1, 6),
(56, 1, 8);
...
INSERT INTO `views` (`id`, `watcherId`, `watchedId`, `viewAt`) VALUES
(1, 1, 2, '2020-10-05 15:43:59'),
(2, 1, 2, '2020-10-05 15:44:21'),
(3, 1, 2, '2020-10-05 15:44:23');
...
--
ALTER TABLE `likes`
  ADD CONSTRAINT `likeUser` FOREIGN KEY (`likeId`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `likedUser` FOREIGN KEY (`likedId`) REFERENCES `users` (`id`);
...
--
ALTER TABLE `views`
  ADD CONSTRAINT `watchedUser` FOREIGN KEY (`watchedId`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `watcherUser` FOREIGN KEY (`watcherId`) REFERENCES `users` (`id`);
COMMIT;
